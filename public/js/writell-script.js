        ...
        function t(e, t) {
            if (e) {
                var a, o = s.getAttribute("href").split("/"),
                    n = o[o.length - 1];
                a = "dark" == e ? "writell-style-dark.css" : "writell-style.css", a = s.getAttribute("href").replace(n, a), s.setAttribute("href", a), localStorage.setItem("mode", e), "dark" == e ? (i.classList.add("text-warning"), i.setAttribute("data-mode", "light")) : (i.classList.remove("text-warning"), i.setAttribute("data-mode", "dark")), document.getElementById("header-main") && function(e) {
